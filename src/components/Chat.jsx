  ...
  return (
    <div className="w-3/4 mx-auto border border-gray-600 m-5 h-[70vh] flex flex-col">
      ...
      <div className="flex-1 overflow-scroll p-5 ">
        {message.map((mssg, index) => {
          return (
            <div key={index} className={"chat "+ (user.firstName === mssg.firstName ? "chat-end": "chat-start")}>
              <div className="chat-header">
                {` ${mssg.firstName} ${mssg.lastName}`}
      ...
      <div className="p-5 border-t border-gray-600 flex gap-2 ">
        ...
        <button onClick={sendMesssage} className="btn btn-secondary">send</button>
      </div>
    </div>
  );
};
